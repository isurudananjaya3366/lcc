"""Fixtures for analytics module tests."""
...
TENANT_DOMAIN = "analytics.testserver"


@pytest.fixture(scope="session")
def setup_test_tenant(django_db_setup, django_db_blocker):
    """Create a test tenant for analytics tests, reusing if it exists."""
...
def staff_user(tenant_context):
    ...
    User = get_user_model()
    u, _ = User.objects.get_or_create(
        email="analytics_staff@example.com",
