...
import { useCart } from '@/components/storefront/providers/CartProvider';
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-1 md:gap-2">
            ...
            >
              ...
              {/* Cart badge */}
              {cartItemCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 bg-green-600 text-white text-xs font-bold rounded-full h-4 w-4 flex items-center justify-center min-w-[1rem]">
